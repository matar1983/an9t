...
export const LEVELS = [
  ...
  },
  {
    ...
    description: "تطوير القدرة على تكوين جمل مركبة واستخدام الأزمان البسيطة والمستمرة والتعبير عن المستقبل بأسلوب تفاعلي ذاتي.",
    features: [
      "شرح الأزمنة الأكثر استخداماً في الحياة اليومية خطوة بخطوة.",
      "مجموعة جديدة من الـ 500 جملة المخصصة لمواقف العمل والحياة الاجتماعية.",
      "قصص وتطبيقات يومية لتعزيز الفهم والاستماع.",
      "محادثات متقدمة للمواقف اليومية وخدمة العملاء.",
      "تدريبات مكثفة على الشادونغ والنطق السليم."
    ],
  ...
  },
  {
    ...
    description: "التعمق في أدوات الربط، الأسماء الموصولة، والقواعد الأكثر تعقيداً في بناء الجمل وتطوير مهارات القراءة والكتابة.",
    features: [
      "إتقان أدوات الربط المتقدمة والتعبير عن الأسباب والتناقضات بطلاقة.",
      "توسيع حصيلتك اللغوية بأكثر من 500 مصطلح وتعبير متقدم.",
      "قصص ومقالات واقعية تناقش مواضيع ثقافية وعامة.",
      "محادثات تفاعلية تحاكي مقابلات العمل والنقاشات الطويلة."
    ],
  ...
  },
  {
    ...
    description: "إتقان المبني للمجهول، والجمل الشرطية المتقدمة، للوصول إلى طلاقة حقيقية ومهارات متقدمة في التحدث والاستماع.",
    features: [
      "دراسة التراكيب النحوية المتقدمة والمبني للمجهول باحترافية.",
      "قائمة متكاملة من التعبيرات الاصطلاحية (Idioms) والمفردات الاحترافية.",
      "تدريبات شادونغ سريعة ومتطورة لسرعة النطق والبديهة.",
      "شهادة إتقان تفاعلية فورية عند إنهاء متطلبات واختبارات المستوى."
    ],
